...
class AllNotificationActivity : AppCompatActivity(), ActionMode.Callback, NotificationFragment.NotificationSettingsListener {
    ...
    private fun loadView() {
        ...
        // Set title
        title = R.string.main_all_notifications.toString()
        ...
        viewModel.list(null).observe(this) {
            it?.let {
                // Show list view
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                runOnUiThread {
                    ...
                    Toast
                        .makeText(this@AllNotificationActivity, message, Toast.LENGTH_LONG)
                        .show()
                }
            }
        }
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            runOnUiThread {
                when (mutedUntilTimestamp) {
                    0L -> Toast.makeText(this@AllNotificationActivity, getString(R.string.notification_dialog_enabled_toast_message), Toast.LENGTH_LONG).show()
                    1L -> Toast.makeText(this@AllNotificationActivity, getString(R.string.notification_dialog_muted_forever_toast_message), Toast.LENGTH_LONG).show()
                    else -> {
                        val formattedDate = formatDateShort(mutedUntilTimestamp)
                        Toast.makeText(this@AllNotificationActivity, getString(R.string.notification_dialog_muted_until_toast_message, formattedDate), Toast.LENGTH_LONG).show()
                    }
                }
            }
        }
    ...
    private fun refresh() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                runOnUiThread {
                    Toast.makeText(this@AllNotificationActivity, toastMessage, Toast.LENGTH_LONG).show()
                ...
                runOnUiThread {
                    Toast
                        .makeText(this@AllNotificationActivity, getString(R.string.refresh_message_error_one, e.message), Toast.LENGTH_LONG)
                        .show()
                    mainListContainer.isRefreshing = false
                }
            }
    ...
    private fun onInstantEnableClick(enable: Boolean) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            runOnUiThread {
                if (enable) {
                    Toast.makeText(this@AllNotificationActivity, getString(R.string.detail_instant_delivery_enabled), Toast.LENGTH_SHORT)
                        .show()
                } else {
                    Toast.makeText(this@AllNotificationActivity, getString(R.string.detail_instant_delivery_disabled), Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
    ...
    private fun onNotificationClick(notification: Notification) {
        if (actionMode != null) {
            ...
            try {
                ...
                runOnUiThread {
                    Toast
                        .makeText(this@AllNotificationActivity, getString(R.string.detail_item_cannot_open_url, e.message), Toast.LENGTH_LONG)
                        .show()
                }
            }
        } else {
    ...
    private fun onMultiCopyClick() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            runOnUiThread {
                ...
                clipboard.setPrimaryClip(clip)
                Toast
                    .makeText(this@AllNotificationActivity, getString(R.string.detail_copied_to_clipboard_message), Toast.LENGTH_LONG)
                    .show()
                finishActionMode()
            }
        }
